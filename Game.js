class Game {
    ...
    props = [
        ...
        [ 2, /* 00000010 */ 2, 'tree',              '🌴', 300, 300,   50, 825, 30 ],
        [ 2, /* 00000010 */ 2, 'tree',              '🌴', 300, 300,   810, 825, 30 ],
        [ 2, /* 00000010 */ 2, 'tree',              '🌴', 300, 300,   1770, 825, 30 ],
        [ 2, /* 00000010 */ 2, 'tree',              '🌴', 300, 300,   2730, 825, 30 ],
        [ 2, /* 00000010 */ 2, 'tree',              '🌴', 300, 300,   3690, 825, 30 ],
        //[ 2, /* 00000110 */ 2, 'ambulance',     '🚑', 200, 200,   1500, 950 ],
        //[ 2, /* 00000110 */ 2, 'police_car',    '🚓' , 200, 200,   2000, 950 ],
        //[ 2, /* 00000110 */ 2, 'police_car',    '🚓' , 200, 200,   2600, 950 ],
        //[ 2, /* 00000110 */ 2, 'lorry',         '🚛',  200, 200,   4040, 950 ],
        //[ 2, /* 00000110 */ 2, 'lorry',         '🚚',  200, 200,   4460, 950 ],
        [ 2, /* 00000110 */ 14, 'department_store', '🏬',  400, 400,   280, 700 ],
        [ 2, /* 00000110 */ 14, 'store',            '🏪',  400, 400,   1240, 700 ],
        [ 2, /* 00000110 */ 14, 'post_office',      '🏤',  400, 400,   2200, 700 ],
        [ 2, /* 00000110 */ 14, 'hotel',            '🏨',  400, 400,   3160, 700 ],
        [ 2, /* 00000110 */ 14, 'house',            '🏠',  400, 400,   4120, 700 ],
        ...
        [ 4, /* 00000010 */ 14, 'woods',           null, 300, 300,   -50, 650 ],
        [ 4, /* 00000010 */ 2, 'tree',           '🌲', 300, 300,   -150, 650 ],
        [ 4, /* 00000010 */ 2, 'tree',           '🌲', 300, 300,   350, 600 ],
        [ 4, /* 00000010 */ 66, 'tree',          '🌲', 300, 300,   150, 550 ],
        [ 4, /* 00000010 */ 130, 'elephant',     '🐘', 200, 200,   875, 600 ],
        [ 4, /* 00000110 */ 14, 'circus',        '🎪', 400, 400,   1240, 650 ],
        [ 4, /* 00000110 */ 2, 'fountain',       '⛲' , 200, 200,   2300, 550 ],
        ...
        // Room 7 - Castle gates
        [ 7, /* 00001110 */ 14, 'castle',        '🏰', 600, 600,   180, 620 ],
        [ 7, /* 00000010 */ 2, 'tree',           '🌲', 300, 300,   -150, 650 ],
        [ 7, /* 00000010 */ 2, 'tree',           '🌲', 300, 300,   810, 650 ],

        // Room 8 - Woods
        [ 8, /* 00000010 */ 6, 'coffin',          '⚰', 100, 100,   180, 660 ],
        [ 8, /* 00000010 */ 2, 'tree',           '🌲', 300, 300,   -150, 650 ],
        [ 8, /* 00000010 */ 2, 'tree',           '🌲', 300, 300,   350, 650 ],
        [ 8, /* 00000010 */ 66, 'tree',          '🌲', 300, 300,   250, 550 ],
        [ 8, /* 00000010 */ 2, 'tree',           '🌲', 350, 350,   -150, 850 ],
        [ 8, /* 00000010 */ 2, 'tree',          '🌳', 400, 400,   800, 600 ],
        [ 8, /* 00000010 */ 2, 'door',          '🚪', 100, 200,   1250, 500 ],

        // Room 9 - Main street south east
        [ 9, /* 00000010 */ 2, 'tree',          '🌴', 300, 300,   50, 825, 30 ],
        [ 9, /* 00000010 */ 2, 'tree',          '🌴', 300, 300,   810, 825, 30 ],
        [ 9, /* 00000010 */ 2, 'tree',          '🌴', 300, 300,   1770, 825, 30 ],
        [ 9, /* 00000110 */ 14, 'house',            '🏠',  400, 400,   1240, 700 ],
        [ 9, /* 00000110 */ 14, 'house',            '🏡',  400, 400,   2200, 700 ],

        // Room 10 - Main street south west
        [ 10, /* 00000010 */ 2, 'tree',          '🌴', 300, 300,   50, 825, 30 ],
        [ 10, /* 00000010 */ 2, 'tree',          '🌴', 300, 300,   810, 825, 30 ],
        [ 10, /* 00000010 */ 2, 'tree',          '🌴', 300, 300,   1770, 825, 30 ],
        [ 10, /* 00000110 */ 14, 'house',            '🏡',  400, 400,   280, 700 ],
        [ 10, /* 00000110 */ 14, 'derelict_house',   '🏚',  400, 400,   1240, 700 ],
