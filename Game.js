class Game {
    ...
    props = [
        ...
        //[ 2, /* 00001110 */ 14, 'office',        '🏢', 400, 400,   280, 700 ],
        ...
        [ 2, /* 00000110 */ 14, 'house',            '🏠', 400, 400,   1240, 700 ],
        //[ 2, /* 00000110 */ 2, 'police_car',    '🚓' , 200, 200,   2000, 950 ],
        //[ 2, /* 00000110 */ 2, 'police_car',    '🚓' , 200, 200,   2600, 950 ],
        [ 2, /* 00000110 */ 14, 'house',            '🏡' , 400, 400,   2200, 700 ],
        [ 2, /* 00000110 */ 14, 'house',            '🏠', 400, 400,   3160, 700 ],
        //[ 2, /* 00000110 */ 2, 'lorry',         '🚛',  200, 200,   4040, 950 ],
        //[ 2, /* 00000110 */ 2, 'lorry',         '🚚',  200, 200,   4460, 950 ],
        [ 2, /* 00000110 */ 14, 'department_store', '🏬',  400, 400,   4120, 700 ],
        [ 2, /* 00000110 */ 14, 'store',            '🏪',  400, 400,   5080, 700 ],
        [ 2, /* 00000110 */ 14, 'post_office',      '🏤',  400, 400,   6040, 700 ],
        [ 2, /* 00000110 */ 14, 'hotel',            '🏨',  400, 400,   7000, 700 ],
        [ 2, /* 00000110 */ 14, 'house',            '🏠',  400, 400,   7960, 700 ],
        [ 2, /* 00000110 */ 14, 'house',            '🏡',  400, 400,   8920, 700 ],
        [ 2, /* 00000110 */ 14, 'derelict_house',   '🏚',  400, 400,   9880, 700 ],
