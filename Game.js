class Game {
    ...
    props = [
        ...
        [ 1,  30, 'hospital',          '🏥', 400, 400,   1240, 700 ],
        [ 1,   2, 'police_car',        '🚓', 200, 200,   2000, 950 ],
        [ 1,   2, 'police_car',        '🚓', 200, 200,   2600, 950 ],
        [ 1,  30, 'courthouse',        '🏛',  400, 400,   2200, 700 ],
        [ 1,  30, 'bank',              '🏦', 400, 400,   3160, 700 ],
        [ 1,   2, 'lorry',             '🚛', 200, 200,   4040, 950 ],
        [ 1,   2, 'lorry',             '🚚', 200, 200,   4460, 950 ],
        [ 1,  30, 'building_site',     '🏗',  400, 400,   4120, 700 ],
        ...
        [ 2, 30, 'department_store',   '🏬', 400, 400,   280,   700 ],
        [ 2,  1, 'shopping_cart',      '🛒', 100, 100,   720,   650 ],
        [ 2, 30, 'store',              '🏪', 400, 400,   1240,  700 ],
        [ 2, 30, 'post_office',        '🏤', 400, 400,   2200,  700 ],
        [ 2, 30, 'hotel',              '🏨', 400, 400,   3160,  700 ],
        [ 2, 30, 'house',              '🏠', 400, 400,   4120,  700 ],

        // Room 3 - House row
        [ 3, 30, 'house',              '🏠', 400, 400,   330, 700 ],
        ...
        [ 4,  30, 'school',            '🏫', 400, 400,   5080, 700 ],
        [ 4,   2, 'tractor',           '🚜', 200, 200,   5900, 950 ],
        [ 4,  30, 'barn',              '🏚',  400, 400,   6100, 540 ],
        ...
        [ 5,  30, 'church',            '⛪', 350, 350,   1240, 700 ],
        [ 5,   2, 'car',               '🚙', 200, 200,   2100, 950 ],
        [ 5,  30, 'house     ',        '🏠', 400, 400,   2200, 700 ],

        // Room 6 - Petrol station
        [ 6,   2, 'pump',              '⛽', 120, 120,   150,  825 ],
        [ 6,   2, 'pump',              '⛽', 120, 120,   620,  825 ],
        [ 6,   2, 'pump',              '⛽', 120, 120,   1090, 825 ],
        [ 6,  30, 'factory',           '🏭', 350, 350,   350,  600, , 499 ],
        [ 6,  30, 'factory',           '🏭', 350, 350,   800,  600, , 499 ],
        ...
        [ 6,  30, 'derelict_house',    '🏚', 400, 400,   1240,  700 ],

        // Room 7 - Castle gates
        [ 7,  30, 'castle',            '🏰', 600, 600,   180,  620 ],
        ...
        [ 9,  30, 'my_house',          '🏠', 400, 400,   1240, 700 ],
        [ 9,  30, 'house',             '🏡', 400, 400,   2200, 700 ],
        ...
        [ 10, 30, 'house',             '🏡', 400, 400,   280,  700 ],
        [ 10, 30, 'derelict_house',    '🏚',  400, 400,   1240, 700 ],
    ...
    init() {
        ...
        this.objs = [];
        this.room = 9;//10;//7;//6;//1; //4; //7; //6;//1; // 4; //6; //1;
